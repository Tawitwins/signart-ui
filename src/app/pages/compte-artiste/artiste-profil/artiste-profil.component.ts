...
@Component({
  selector: 'app-artiste-profil',
  templateUrl: './artiste-profil.component.html',
  styleUrls: ['./artiste-profil.component.scss']
})
export class ArtisteProfilComponent implements OnInit {
